...
import { LogOut, BookOpen, FileQuestion, LayoutDashboard, Users, Sparkles, Orbit, FolderOpen, Target } from "lucide-react";
...
export default function Navbar() {
  ...
  const links = [
    ...
    ...(user.role === "student" ? [{ to: "/adaptive", label: "For You", icon: Target }] : []),
